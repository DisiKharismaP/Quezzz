...
import disiiy.khaper.quezzz.databinding.FragmentQuizBinding
import disiiy.khaper.quezzz.model.Quiz
...
class QuizFragment : Fragment() {
    ...
    private fun setNumberQuestion() {
        ...
        answers.shuffle()
        (activity as AppCompatActivity).supportActionBar?.title = getString(R.string.title_quezzz, questionIndex + 1, numberIndicatorQuestion)
    }
